...
export function ClozeFill({ item, disabled, onSubmit }: EngineProps<ClozeItem>) {
  ...
  return (
    <div className="space-y-5">
      ...
      <input
        ...
        autoFocus
      />
      <Button type="button" size="lg" disabled={disabled} className="w-full justify-center" onClick={() => onSubmit(value)}>
        Check
      </Button>
    </div>
  );
